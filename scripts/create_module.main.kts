...
fun createSourceStructure(config: ModuleConfig, moduleDir: File) {
    val packagePath = "com.sodogku.${config.baseDir}.${config.fullName.replace(":", ".")}".replace(".", "/")
...
fun createMainSourceFile(config: ModuleConfig, kotlinDir: File) {
    val packageName = "com.sodogku.${config.baseDir}.${config.fullName.replace(":", ".")}"
...
fun createFeatureEntryPoint(config: ModuleConfig, kotlinDir: File, packageName: String) {
    ...
    val (routePackage, routeClass) = if (config.moduleName == "impl" && config.parentModule != null) {
        ...
        val parentPackage = "com.sodogku.${config.baseDir}.${config.parentModule}"
...
${routeImport}import com.sodogku.libraries.navigation.FeatureEntryPoint
...
fun createBuildGradle(config: ModuleConfig, moduleDir: File) {
    ...
    val namespace = "com.sodogku.${config.baseDir}.${config.fullName.replace(":", ".")}"
